...
<body>
	<div id="main">
		...
		<div id="speech">
			<div id="boxes">
				<a href="media/Jete_Jete_Ekla_Pathe(SumirBd.Mobi).mp3" width="100" height="100"><button type="submit" class="buttona">Play a mp3</button></a>
				<a href="media/‪Linkin_Park_New Divide.mp4" width="500" height="300"><button type="submit" class="buttonv">Play a video</button></a>
				</div>
		</div>
		<div id="sign">
