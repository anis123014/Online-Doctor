	...
	<div id="main">
		...
		<div id="speech">
			<div id="boxes">
				...
				<button type="submit" class="button3">Golden Moment</button>
			</form>
			<form action="auvi.php"  method="post" enctype="multipart/form-data">
				<button type="submit" class="button4">Audio/Video</button>
				</form>
				</div>
		</div>
		<div id="sign">
